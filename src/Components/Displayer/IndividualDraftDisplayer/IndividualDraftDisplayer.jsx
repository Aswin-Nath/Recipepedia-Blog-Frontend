...
import "./IndividualDraftDisplayer.css";
...
const IndividualDraftDisplayer = () => {
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      ...
      setReadtime(
        Math.ceil(response.data.blog[0].content.split(/\s+/).length / averageWPM)
      );
      setload(false);
    };
    fetchBlog();
                  ...
                  <>
                    ...
                    <div className="overlay-navigation">
                      <button
                        ...
                        style={{
                          visibility:
                            selectedImage.index > 0 ? "visible" : "hidden",
                        }}
                      >
                        ←
                      </button>
                      <button
                        ...
                        style={{
                          visibility:
                            selectedImage.index < image_urls.length - 1
                              ? "visible"
                              : "hidden",
                        }}
                      >
...
export default IndividualDraftDisplayer;
