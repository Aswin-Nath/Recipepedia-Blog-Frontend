...
const Navbar = () => {
    ...
    // Listen for socket notify event
    useEffect(() => {
        fetchUnreadCount();
        const handleNotify = () => fetchUnreadCount();
    ...
    // When notification panel is opened, reset unread count (optional)
    useEffect(() => {
        if (openNotification) fetchUnreadCount();
    }, [openNotification]);
